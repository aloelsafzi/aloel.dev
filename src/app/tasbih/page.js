  ...
  return (
    <>
      ...
      <Main className={'mt-10'}>
        ...
        <div className="flex flex-col justify-center items-center gap-y-6 mt-10">
          ...
          <div className="flex justify-center items-center gap-x-2">
            ...
            <button onClick={onClickreset} className="bg-gray-50 border-gray-300 border p-2.5 w-20 rounded-3xl text-sm focus:ring-1 focus:ring-blue-200">Reset</button>
          </div>
        </div>
      </Main>  
    </>
