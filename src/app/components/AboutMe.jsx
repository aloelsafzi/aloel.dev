  ...
  return (
    <>
      <div className="flex flex-col items-center mx-3 lg:w-3/5 lg:ml-12 lg:items-start">
        ...
        <a href={process.env.linkCv} className="bg-blue-400 px-2 py-1 rounded-md shadow-inner w-full md:w-fit my-6 font-semibold text-center text-white">Get Resume</a>
      </div>
    </>
  )
}
